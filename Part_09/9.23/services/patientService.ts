...
import { PublicPatient, Patient, EntryType } from '../types';
...
const addPatientEntries = (id: string, entries: Array<EntryType>): PublicPatient => {
    ...
    if (foundPatient) {
        ...
        const updatedPatient = getNonSensitiveEntry(foundPatient);
